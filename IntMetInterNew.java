 ...
 * @author tristan
 */
public class IntMetInterNew extends javax.swing.JFrame {

    /**
     * Creates new form IntMetInterNew
     */
    public IntMetInterNew() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Interpolacion de Newton");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/intronewton.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MetInerNewt newt=new MetInerNewt();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntMetInterNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntMetInterNew().setVisible(true);
            }
        });
    }
