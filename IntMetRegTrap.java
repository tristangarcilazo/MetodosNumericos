 ...
 * @author tristan
 */
public class IntMetRegTrap extends javax.swing.JFrame {

    /**
     * Creates new form IntMetRegTrap
     */
    public IntMetRegTrap() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Regla trapezoidal");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/trapecio.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MetRegTrap trap=new MetRegTrap();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntMetRegTrap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntMetRegTrap().setVisible(true);
            }
        });
    }
