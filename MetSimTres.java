 ...
 * @author tristan
 */
public class MetSimTres extends javax.swing.JFrame {

    /**
     * Creates new form MetSimTres
     */
    public MetSimTres() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetSimTres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MetSimTres().setVisible(true);
            }
        });
    }
