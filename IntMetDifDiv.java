 ...
 * @author tristan
 */
public class IntMetDifDiv extends javax.swing.JFrame {

    /**
     * Creates new form IntMetDifDiv
     */
    public IntMetDifDiv() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diferencias Divididas");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/introdifer_1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MetDifDiv dife=new MetDifDiv();
        dife.setLocationRelativeTo(null);
        this.setVisible(false);
        dife.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntMetDifDiv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntMetDifDiv().setVisible(true);
            }
        });
    }
