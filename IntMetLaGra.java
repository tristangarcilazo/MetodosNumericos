 ...
 * @author tristan
 */
public class IntMetLaGra extends javax.swing.JFrame {

    /**
     * Creates new form IntMetLaGra
     */
    public IntMetLaGra() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Polinomios de Lagrange");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/introlag.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntMetLaGra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntMetLaGra().setVisible(true);
            }
        });
    }
