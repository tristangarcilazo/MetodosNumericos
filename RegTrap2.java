 ...
 * @author tristan
 */
public class RegTrap2 extends javax.swing.JFrame {

    /**
     * Creates new form RegTrap2
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegTrap2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegTrap2().setVisible(true);
                JOptionPane.showMessageDialog(null, "Ingrese los limites de integración así como el numero de iteraciones deseado"
                + "\nposteriormente presione el botón correr método", "Intrucciones", JOptionPane.INFORMATION_MESSAGE);
            }
        });
    }
